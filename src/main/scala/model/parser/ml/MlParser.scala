...
import model.parser.util.GrammarTree.*
import model.parser.util.TypeOps.*
...
import model.parser.ml.MlParser.*
...
case class MlParser[F[_]: Monad](inputStream: InputStream) {
  ...
  val lex: MlLexer = MlLexer(inputStream, MlLexer(inputStream,
  ...
  def otherCont(fromTerm : Expression) : MlParseState[OtherContContext] = {
    for {
      ...
      res <-
        if (lex.curTokenIn(Set(MlToken.MUL, MlToken.LT, MlToken.DIV, MlToken.SUB, MlToken.EQ_CMP, MlToken.GT, MlToken.ADD))) {
          for {
        ...
        else if (lex.curTokenIn(Set(MlToken.SND, MlToken.VAR, MlToken.BOOL, MlToken.LET, MlToken.NUMBER, MlToken.OPEN_PAIR, MlToken.LPAREN, MlToken.FUN, MlToken.IF, MlToken.FST))) {
          for {
            curState <- StateT.pure[MlMET, MlLexer, List[GrammarTree[_]]](List.empty)
            a <- expr()
      ...
      res <-
        if (lex.curTokenIn(Set(MlToken.OPEN_PAIR))) {
          for {
            ...
            curState <- StateT.pure[MlMET, MlLexer, List[GrammarTree[_]]](curState)
      ...
      res <-
        if (lex.curTokenIn(Set(MlToken.LET))) {
          for {
            ...
            // USER CODE
            res = if (l.res == "letrec") LetRecTerm(v.text, valueExpr.res, inExpr.res) else LetTerm(v.text, valueExpr.res, inExpr.res)
            // END USER CODE
  ...
  def otherQcont(fromTerm : Expression) : MlParseState[OtherQcontContext] = {
    for {
      lex <- StateT.get[MlMET, MlLexer]
      res <-
        if (lex.curTokenIn(Set(MlToken.SND, MlToken.VAR, MlToken.DIV, MlToken.SUB, MlToken.LET, MlToken.EQ_CMP, MlToken.NUMBER, MlToken.OPEN_PAIR, MlToken.GT, MlToken.ADD, MlToken.LPAREN, MlToken.FUN, MlToken.MUL, MlToken.BOOL, MlToken.LT, MlToken.IF, MlToken.FST))) {
          for {
            curState <- StateT.pure[MlMET, MlLexer, List[GrammarTree[_]]](List.empty)
        ...
        else if (lex.curTokenIn(Set(MlToken.RPAREN, MlToken.THEN, MlToken.IN, MlToken.EOF, MlToken.COMMA, MlToken.CLOSE_PAIR, MlToken.ELSE))) {
          for {
            curState <- StateT.pure[MlMET, MlLexer, List[GrammarTree[_]]](List.empty)
  ...
  def parse() : MlParseState[ParseContext] = {
    for {
      lex <- StateT.get[MlMET, MlLexer]
      res <-
        if (lex.curTokenIn(Set(MlToken.SND, MlToken.VAR, MlToken.BOOL, MlToken.LET, MlToken.NUMBER, MlToken.OPEN_PAIR, MlToken.LPAREN, MlToken.FUN, MlToken.IF, MlToken.FST))) {
          for {
            curState <- StateT.pure[MlMET, MlLexer, List[GrammarTree[_]]](List.empty)
            e <- expr()
            curState <- StateT.pure[MlMET, MlLexer, List[GrammarTree[_]]](curState).map(list => e :: list)
...
object MlParser {
  ...
  case class OtherContContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    ...
    override def pushFirstChild(child: GrammarTree[_]): OtherContContext = OtherContContext(ctxRoot, child::ctxChildren)
    override def appendLastChild(child: GrammarTree[_]): OtherContContext = OtherContContext(ctxRoot, ctxChildren ++ List(child))
  }
  ...
  case class PairExprContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    ...
    override def appendLastChild(child: GrammarTree[_]): PairExprContext = PairExprContext(ctxRoot, ctxChildren ++ List(child))
  }
  ...
  case class LetQrecContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: String = null)
    ...
    override def appendLastChild(child: GrammarTree[_]): LetQrecContext = LetQrecContext(ctxRoot, ctxChildren ++ List(child))
  }
  ...
  case class IfExprContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    ...
    override def appendLastChild(child: GrammarTree[_]): IfExprContext = IfExprContext(ctxRoot, ctxChildren ++ List(child))
  }
  ...
  case class FuncExprContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    ...
    override def appendLastChild(child: GrammarTree[_]): FuncExprContext = FuncExprContext(ctxRoot, ctxChildren ++ List(child))
  }

  case class OtherExprContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    extends ContextTree(ctxRoot, ctxChildren) {
    override def pushFirstChild(child: GrammarTree[_]): OtherExprContext = OtherExprContext(ctxRoot, child::ctxChildren)
    override def appendLastChild(child: GrammarTree[_]): OtherExprContext = OtherExprContext(ctxRoot, ctxChildren ++ List(child))
  }

  case class LetQrecExprContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    extends ContextTree(ctxRoot, ctxChildren) {
    override def pushFirstChild(child: GrammarTree[_]): LetQrecExprContext = LetQrecExprContext(ctxRoot, child::ctxChildren)
    override def appendLastChild(child: GrammarTree[_]): LetQrecExprContext = LetQrecExprContext(ctxRoot, ctxChildren ++ List(child))
  }
  ...
  case class BinOpContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: BinaryOperation = null)
    ...
    override def appendLastChild(child: GrammarTree[_]): BinOpContext = BinOpContext(ctxRoot, ctxChildren ++ List(child))
  }
  ...
  case class FstExprContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    ...
    override def appendLastChild(child: GrammarTree[_]): FstExprContext = FstExprContext(ctxRoot, ctxChildren ++ List(child))
  }
  ...
  case class SndExprContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    ...
    override def appendLastChild(child: GrammarTree[_]): SndExprContext = SndExprContext(ctxRoot, ctxChildren ++ List(child))
  }

  case class OtherQcontContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    extends ContextTree(ctxRoot, ctxChildren) {
    override def pushFirstChild(child: GrammarTree[_]): OtherQcontContext = OtherQcontContext(ctxRoot, child::ctxChildren)
    override def appendLastChild(child: GrammarTree[_]): OtherQcontContext = OtherQcontContext(ctxRoot, ctxChildren ++ List(child))
  }
  ...
  case class ParseContext(ctxRoot: String, ctxChildren: List[GrammarTree[_]] = List.empty, res: Expression = null)
    ...
    override def appendLastChild(child: GrammarTree[_]): ParseContext = ParseContext(ctxRoot, ctxChildren ++ List(child))
  }
}
